  ...
  try {
    ...
    const quotation = await prisma.quotation.update({
      ...
      data: {
        ...
        estimatedTotal:
          data.estimatedTotal !== undefined ? data.estimatedTotal : undefined,
...
// PATCH - Actualizar cotización parcialmente
  ...
  try {
    ...
    const quotation = await prisma.quotation.update({
      ...
      data: {
        ...
        ...(data.diagnosisMechanicNotes !== undefined && {
          diagnosisMechanicNotes: data.diagnosisMechanicNotes,
        }),
        ...(data.externalDiagnosisCode !== undefined && {
          externalDiagnosisCode: data.externalDiagnosisCode,
        }),
      },
      include: {
        client: true,
